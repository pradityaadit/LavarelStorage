...
<body>
    ...
    <nav class="bg-white border-b border-gray-200" x-data="{ openMenu: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex md:justify-between items-center py-6 sm:h-16  gap-10">
                <div class="flex pr-8">
                    <!-- Logo / Brand -->
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-8">
                    <a href="{{ route('welcome') }}" class="text-gray-900 hover:bg-gray-50 px-3 py-2 rounded-md text-sm font-medium">Home</a>

                    <!-- Dropdown for Data Mahasiswa -->
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center text-gray-900 hover:bg-gray-50 px-3 py-2 rounded-md text-sm font-medium focus:outline-none">
                            Data Mahasiswa
                            <svg class="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" @click.outside="open = false" x-transition class="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                    ...
                    <a href="#" class="text-gray-900 hover:bg-gray-50 px-3 py-2 rounded-md text-sm font-medium">Services</a>
                    <a href="#" class="text-gray-900 hover:bg-gray-50 px-3 py-2 rounded-md text-sm font-medium">Contact</a>

                    <!-- Profile Dropdown -->
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center text-sm font-medium text-gray-900 hover:text-gray-600 focus:outline-none">
                            <span>Profile</span>
                            <svg class="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
